...
/* USER CODE BEGIN PV */
volatile uint8_t initComplete = 0;
/* USER CODE END PV */
...
static void MX_DMA_Init(void)
{
  ...
  hdma_memtomem_dma1_channel6.Init.Priority = DMA_PRIORITY_VERY_HIGH;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(OD_C_GPIO_Port, OD_C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OD_B_Pin|OD_A_Pin|signal_Pin|LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : OD_C_Pin */
  GPIO_InitStruct.Pin = OD_C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(OD_C_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : OD_B_Pin OD_A_Pin */
  GPIO_InitStruct.Pin = OD_B_Pin|OD_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
